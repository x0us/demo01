 ...
 * @param [lang] {string} - The default language fallback to browser language if not set
 */
export function createI18nContext(init = {}, lang = (typeof navigator !== 'undefined' && navigator.language) in init ? init[navigator.language] : Object.keys(init)[0]) {
